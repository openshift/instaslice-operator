...
import (
	...
	instasliceoperatorapiv1alpha1 "github.com/openshift/instaslice-operator/api/v1alpha1"
	versioned "github.com/openshift/instaslice-operator/internal/generated/clientset/versioned"
	internalinterfaces "github.com/openshift/instaslice-operator/internal/generated/informers/externalversions/internalinterfaces"
	apiv1alpha1 "github.com/openshift/instaslice-operator/internal/generated/listers/api/v1alpha1"
...
type InstasliceOperatorInformer interface {
	...
	Lister() apiv1alpha1.InstasliceOperatorLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApiV1alpha1().InstasliceOperators(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApiV1alpha1().InstasliceOperators(namespace).Watch(context.TODO(), options)
			},
		},
		&instasliceoperatorapiv1alpha1.InstasliceOperator{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *instasliceOperatorInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&instasliceoperatorapiv1alpha1.InstasliceOperator{}, f.defaultInformer)
}

func (f *instasliceOperatorInformer) Lister() apiv1alpha1.InstasliceOperatorLister {
	return apiv1alpha1.NewInstasliceOperatorLister(f.Informer().GetIndexer())
}
