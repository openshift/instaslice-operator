...
import (
	...
	internal "github.com/openshift/instaslice-operator/internal/generated/applyconfiguration/internal"
...
// Experimental!
func ExtractInstasliceOperator(instasliceOperator *apiv1alpha1.InstasliceOperator, fieldManager string) (*InstasliceOperatorApplyConfiguration, error) {
...
// Experimental!
func ExtractInstasliceOperatorStatus(instasliceOperator *apiv1alpha1.InstasliceOperator, fieldManager string) (*InstasliceOperatorApplyConfiguration, error) {
	return extractInstasliceOperator(instasliceOperator, fieldManager, "status")
}

func extractInstasliceOperator(instasliceOperator *apiv1alpha1.InstasliceOperator, fieldManager string, subresource string) (*InstasliceOperatorApplyConfiguration, error) {
	b := &InstasliceOperatorApplyConfiguration{}
	err := managedfields.ExtractInto(instasliceOperator, internal.Parser().Type("com.github.openshift.instaslice-operator.api.v1alpha1.InstasliceOperator"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
