...
type NodeAcceleratorLister interface {
	...
	List(selector labels.Selector) (ret []*dasoperatorv1alpha1.NodeAccelerator, err error)
...
type nodeAcceleratorLister struct {
	listers.ResourceIndexer[*dasoperatorv1alpha1.NodeAccelerator]
}
...
func NewNodeAcceleratorLister(indexer cache.Indexer) NodeAcceleratorLister {
	return &nodeAcceleratorLister{listers.New[*dasoperatorv1alpha1.NodeAccelerator](indexer, dasoperatorv1alpha1.Resource("nodeaccelerator"))}
}

// NodeAccelerators returns an object that can list and get NodeAccelerators.
func (s *nodeAcceleratorLister) NodeAccelerators(namespace string) NodeAcceleratorNamespaceLister {
	return nodeAcceleratorNamespaceLister{listers.NewNamespaced[*dasoperatorv1alpha1.NodeAccelerator](s.ResourceIndexer, namespace)}
}
...
type NodeAcceleratorNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*dasoperatorv1alpha1.NodeAccelerator, error)
