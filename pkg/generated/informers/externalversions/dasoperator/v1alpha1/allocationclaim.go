...
import (
	...
	apisdasoperatorv1alpha1 "github.com/openshift/instaslice-operator/pkg/apis/dasoperator/v1alpha1"
	...
	dasoperatorv1alpha1 "github.com/openshift/instaslice-operator/pkg/generated/listers/dasoperator/v1alpha1"
...
type AllocationClaimInformer interface {
	...
	Lister() dasoperatorv1alpha1.AllocationClaimLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OpenShiftOperatorV1alpha1().AllocationClaims(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpenShiftOperatorV1alpha1().AllocationClaims(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpenShiftOperatorV1alpha1().AllocationClaims(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpenShiftOperatorV1alpha1().AllocationClaims(namespace).Watch(ctx, options)
			},
		},
		&apisdasoperatorv1alpha1.AllocationClaim{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *allocationClaimInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisdasoperatorv1alpha1.AllocationClaim{}, f.defaultInformer)
}

func (f *allocationClaimInformer) Lister() dasoperatorv1alpha1.AllocationClaimLister {
	return dasoperatorv1alpha1.NewAllocationClaimLister(f.Informer().GetIndexer())
}
