...
type NodeAcceleratorInformer interface {
	...
	Lister() dasoperatorv1alpha1.NodeAcceleratorLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OpenShiftOperatorV1alpha1().NodeAccelerators(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpenShiftOperatorV1alpha1().NodeAccelerators(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpenShiftOperatorV1alpha1().NodeAccelerators(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpenShiftOperatorV1alpha1().NodeAccelerators(namespace).Watch(ctx, options)
			},
		},
		&apisdasoperatorv1alpha1.NodeAccelerator{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *nodeAcceleratorInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisdasoperatorv1alpha1.NodeAccelerator{}, f.defaultInformer)
}

func (f *nodeAcceleratorInformer) Lister() dasoperatorv1alpha1.NodeAcceleratorLister {
	return dasoperatorv1alpha1.NewNodeAcceleratorLister(f.Informer().GetIndexer())
}
