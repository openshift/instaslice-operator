...
type DASOperatorInformer interface {
	...
	Lister() dasoperatorv1alpha1.DASOperatorLister
}
...
func (f *dASOperatorInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisdasoperatorv1alpha1.DASOperator{}, f.defaultInformer)
}

func (f *dASOperatorInformer) Lister() dasoperatorv1alpha1.DASOperatorLister {
	return dasoperatorv1alpha1.NewDASOperatorLister(f.Informer().GetIndexer())
}
