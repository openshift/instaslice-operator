...
func extractAllocationClaim(allocationClaim *dasoperatorv1alpha1.AllocationClaim, fieldManager string, subresource string) (*AllocationClaimApplyConfiguration, error) {
	b := &AllocationClaimApplyConfiguration{}
	err := managedfields.ExtractInto(allocationClaim, internal.Parser().Type("com.github.openshift.instaslice-operator.pkg.apis.dasoperator.v1alpha1.AllocationClaim"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
func (b AllocationClaimApplyConfiguration) IsApplyConfiguration() {}
...
func (b *AllocationClaimApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *AllocationClaimApplyConfiguration) GetAPIVersion() *string {
...
func (b *AllocationClaimApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
