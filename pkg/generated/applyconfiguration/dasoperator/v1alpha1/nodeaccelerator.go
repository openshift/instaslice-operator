...
func extractNodeAccelerator(nodeAccelerator *dasoperatorv1alpha1.NodeAccelerator, fieldManager string, subresource string) (*NodeAcceleratorApplyConfiguration, error) {
	b := &NodeAcceleratorApplyConfiguration{}
	err := managedfields.ExtractInto(nodeAccelerator, internal.Parser().Type("com.github.openshift.instaslice-operator.pkg.apis.dasoperator.v1alpha1.NodeAccelerator"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
func (b NodeAcceleratorApplyConfiguration) IsApplyConfiguration() {}
...
func (b *NodeAcceleratorApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *NodeAcceleratorApplyConfiguration) GetAPIVersion() *string {
...
func (b *NodeAcceleratorApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
