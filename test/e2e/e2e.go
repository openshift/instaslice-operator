...
var _ = Describe("DAS E2E", Ordered, func() {
	_ = Describe("Test pods for requesting single type of extended resource", Ordered, func() {
		var (
			podNames  []string
			namespace string
		)
	...
	_ = Describe("Test pods requesting multiple resources", Ordered, func() {
		var (
			podNames  []string
			namespace string
		)
	...
	_ = Describe("Test pods for requesting multiple slice types", Ordered, func() {
		var (
			podNames  []string
			namespace string
		)
